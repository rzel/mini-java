...
//      System.out.println(" Node::addChild: " + child.data);
        if (children == null) {
            children = new ArrayList<Node<T>>();
        }
        children.add(child);
     ...
     * @throws IndexOutOfBoundsException if thrown.
     */
    public Node<T> removeChildAt(int index) throws IndexOutOfBoundsException {
    ...
    public void dump() {
        System.out.println("\n==================== Node =====================");
//      System.out.println(" NumOfChildren: " + children.size());
        dumpHelper(this, 2);        

        System.out.println("=================================================\n");
    }

    private void dumpHelper(Node<T> root, int indent) {
...
//        try { System.in.read(); } catch(Exception ex) {};
    ...
    public String toString() {
        ...
        sb.append("{").append(data == null ? "null" : data.toString()).append(",[");
        int i = 0;
